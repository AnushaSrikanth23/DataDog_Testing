...
if (builder.Environment.IsDevelopment() || builder.Environment.EnvironmentName == "Docker"){
    ...
    string commit_sha = Environment.GetEnvironmentVariable("DD_GIT_COMMIT_SHA",EnvironmentVariableTarget.Machine);
    string DD_GIT_REPOSITORY_URL = Environment.GetEnvironmentVariable("DD_GIT_REPOSITORY_URL",EnvironmentVariableTarget.Machine);
    if (commit_sha==null)
        Environment.SetEnvironmentVariable("DD_GIT_COMMIT_SHA", "96a21fb91faa6865914f86d4f27ec85cdd926bb0", EnvironmentVariableTarget.Machine);
    if(DD_GIT_REPOSITORY_URL==null)
        Environment.SetEnvironmentVariable("DD_GIT_REPOSITORY_URL", "https://github.com/Parthiban171914/NeuroITSample", EnvironmentVariableTarget.Machine);
